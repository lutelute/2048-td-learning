#!/usr/bin/env node
// 4x4 Training script: node --max-old-space-size=512 scripts/train4x4.js [options]
// Options:
//   --episodes N              Total episodes (default: 100000)
//   --lr N                    Learning rate (default: 0.001)
//   --eval-interval N         Eval every N episodes (default: 5000)
//   --checkpoint-interval N   Save every N episodes (default: 25000)
...
import { Trainer } from '../src/training/trainer4x4.js';
